...
const faqs =[
  ...
  { q: '서버 오픈 시간은 어떻게 되나요?', a: '점검 시 제외 24시간 언제든 자유롭게 접속하여 즐기실 수 있습니다.' },
  ...
  { q: '초보자도 쉽게 적응할 수 있나요?', a: "물론입니다! 인게임 '튜토리얼 존'에서 안전하게 튜토리얼을 진행하며, 서버의 기초적인 시스템부터 천천히 안내 받을 수 있습니다." },
  ...
  { q: '모드팩을 다운 받았는데, 어떻게 적용해야 하나요?', a: "CurseForge의 'My Modpacks' 화면에서 'Import' 버튼을 클릭하신 뒤, 'Import ZIP File'을 선택해주세요. 그 다음 새로 열린 파일탐색기 창에서 앞서 다운 받은 '헤르빌 v.(버전명).zip' 파일을 선택해 적용해주세요." },
];
