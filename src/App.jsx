...
const regions =[
  ...
  },
  {
    ...
    desc: '헤르빌 대륙 동부의 온갖 상단과 물자, 화폐가 오가는 항구 지역. 교역과 길드의 중심지입니다.',
    color: 'text-teal-600',
    bg: 'bg-teal-50',
  },
  {
...
// --- [데이터] FAQ ---
const faqs =[
  { q: '헤르빌 리부트는 어떤 서버인가요?', a: '전투 경쟁보다는 농사, 탐험, 마도공학 등 천천히 자신만의 이야기를 만들어가는 힐링 오픈월드 RPG 서버입니다.' },
  { q: '서버 오픈 시간은 어떻게 되나요?', a: '24시간 언제든 자유롭게 접속하여 즐기실 수 있습니다.' },
  { q: '마인크래프트 정품만 접속 가능한가요?', a: '네, 헤르빌은 건전한 서버 문화를 위해 100% 마인크래프트 정품 유저만 접속이 가능합니다.' },
  { q: '모드팩 적용은 필수인가요?', a: "네, 다양한 지역(마도공학, 농경 등)과 RPG 시스템을 구현하기 위해 전용 모드팩 설치가 필수입니다. '다운로드' 탭을 참고해 주세요." },
  { q: '모바일(BE)로도 접속할 수 있나요?', a: '아쉽게도 모드가 포함된 자바 에디션(Java Edition) 1.20.1 버전으로만 접속이 가능합니다.' },
  { q: '초보자도 쉽게 적응할 수 있나요?', a: "물론입니다! 남부 '솔라리스' 지역에서 안전하게 튜토리얼을 진행하며 농사와 채집부터 천천히 배울 수 있습니다." },
  { q: '유저 간 PVP(전투)가 가능한가요?', a: "원칙적으로 힐링 서버이므로 무분별한 PVP는 금지되어 있습니다. 단, 북부 '프론티어' 지역의 특정 구역에서는 예외적인 룰이 적용될 수 있습니다." },
  { q: '건축에 제한이 있나요?', a: '개인 토지 안에서는 자유롭게 건축이 가능하지만, 서버 렉을 유발하는 과도한 레드스톤 회로나 공장 지형은 규제될 수 있습니다.' },
  { q: '후원 상점이 따로 존재하나요?', a: '게임 밸런스를 해치는(Pay to Win) 장비 판매는 없으며, 치장용 아이템이나 칭호 위주의 가벼운 후원만 운영될 예정입니다.' },
  { q: '게임 중 버그를 발견하면 어떻게 하나요?', a: "공식 디스코드 서버의 '버그 제보' 채널에 남겨주시면 관리자가 확인 후 신속히 조치해 드립니다." },
];
    ...
    <div className="font-sans text-gray-800 bg-bglight min-h-screen">
      ...
      <section id="faq" className="max-w-4xl mx-auto px-6 py-32">
        ...
        >
          ...
          <motion.a
            href="https://discord.gg/YOUR_INVITE_LINK" // 디스코드 링크 삽입
            target="_blank"
            whileHover={{ scale: 1.05 }}
